...
CENTRAL_ORCHESTRATOR_AGENT_MODEL_NAME   = os.getenv("INVENTORY_AGENT_LLM_MODEL_NAME", 'gemini-2.5-flash')
INVENTORY_AGENT_LLM_MODEL_NAME          = os.getenv("INVENTORY_AGENT_LLM_MODEL_NAME", 'gemini-2.5-flash')
LOGISTICS_AGENT_LLM_MODEL_NAME          = os.getenv("LOGISTICS_AGENT_LLM_MODEL_NAME", 'gemini-2.5-flash')
SUPPLIER_AGENT_LLM_MODEL_NAME           = os.getenv("SUPPLIER_AGENT_LLM_MODEL_NAME", 'gemini-2.5-flash')

# CENTRAL_ORCHESTRATOR_AGENT_MODEL_NAME   = os.getenv("INVENTORY_AGENT_LLM_MODEL_NAME", 'gemini-2.5-pro')
